...
/**
 * error_env - or message for shellby_env errors.
...
/**
 * error_1 -for shellby_alias errors.
 * @args: to the command.
...
/**
 * error_2_cd - r message for shellby_cd errors.
 * @args: An array of argume.
 * Return: The error string.
 */
char *error_2_cd(char **args)
{
...
/**
 * error_2_syntax -creates sytax error
 * @args: An arraumentsnd.
 * Return: The error string.
 */
char *error_2_syntax(char **args)
{
