...
/**
 * help_all - display all possible commands commands.
 */
void help_all(void)
{
...
/**
 * help_alias - Displays information on command 'alias'.
 */
void help_alias(void)
{
...
/**
 * help_exit - display informationy builtin command 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_help - Displays inforamtion on command 'help'.
 */
void help_help(void)
{
